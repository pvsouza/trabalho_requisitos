...
public class AdicionarMotocicletaForm extends JFrame {
	 ...
	 * FLAG: 1 - carro 2 - moto
	 */
	public AdicionarMotocicletaForm(final Loja loja) {
		setAlwaysOnTop(true);
		setResizable(false);
		setTitle("Adicionar Motocicleta");
