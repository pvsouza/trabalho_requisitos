...
public class AdicionarForm extends JFrame {
	 ...
	 * 2 - moto
	 */
	public AdicionarForm(int flag, final Loja loja) {
		setAlwaysOnTop(true);
		setResizable(false);
		setTitle("Adicionar");
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Sedan", "Hatch"}));
